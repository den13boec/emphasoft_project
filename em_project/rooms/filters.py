...
class RoomFilter(django_filters.FilterSet):
    ...
    start_date = django_filters.DateFilter(label='Start date', method='filter_by_availability')
    end_date = django_filters.DateFilter(label='End date', method='filter_by_availability')
